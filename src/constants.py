...
TIMEOUT_GIT_CLONE = 600
TIMEOUT_GIT_PUSH = 300
TIMEOUT_GIT_FETCH = 120
TIMEOUT_GH_COMMAND = 120  # default gh CLI timeout (also in github.py)
TIMEOUT_GH_DIFF = 180
TIMEOUT_NAVIGATION_MODEL = 300
TIMEOUT_REVIEW_AGENT = 900
TIMEOUT_VERIFY_AGENT = 900
TIMEOUT_TRIAGE_MODEL = 180
TIMEOUT_BATCH_ORCHESTRATION = 300
TIMEOUT_CONFLICT_CHECK = 120
TIMEOUT_PR_CREATE = 180
TIMEOUT_COMMIT_PUSH = 300
